...
public class NavigationItemsAdapter extends ArrayAdapter<NavigationItemsAdapter.NavItem> {
    ...
    public NavigationItemsAdapter(Context context) {
        ...
        mDataset.add(new NavItem(R.drawable.ic_radical_black_24dp, R.string.title_status));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_drive));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_io));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_cells));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_motor));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_pid));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_fault));
        mDataset.add(new NavItem(R.drawable.ic_kanji_black_24dp, R.string.title_parameters));
        mDataset.add(new NavItem(R.drawable.ic_vocabulary_black_24dp, R.string.title_configuration));
    }
