...
public class MaterialTextField extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        System.out.println("cardCollapsedHeight:"+cardCollapsedHeight);
        card.getLayoutParams().height = cardCollapsedHeight - 4;
        card.requestLayout();
    ...
    protected void customizeFromAttributes() {
        ...
        if (cardColor != -1) {
            if(card instanceof CardView)
                CardView.class.cast(this.card).setBackgroundColor(cardColor); //setCardBackgroundColor(cardColor)
        }
    ...
    public void reduce() {
        if (expanded) {
            ...
            ValueAnimator expand = ValueAnimator.ofInt(card.getHeight(), cardCollapsedHeight - 4);
    ...
    public void expand() {
        if (!expanded) {
            ...
            animatorSet.playTogether(
                    ...
                    ObjectAnimator.ofFloat(label, "scaleX", 0.9f),
                    ObjectAnimator.ofFloat(label, "scaleY", 0.9f),
                    ObjectAnimator.ofFloat(label, "translationY", -(labelTopMargin - (labelTopMargin / 4))),
